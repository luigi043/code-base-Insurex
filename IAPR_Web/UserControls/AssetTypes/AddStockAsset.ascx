<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddStockAsset.ascx.cs" Inherits="IAPR_Web.UserControls.AssetTypes.AddStockAsset" %>





<h6 class="m-0 font-weight-bold text-primary">Stock asset details</h6>
...
<div class="form-row align-items-center">
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Asset cover type</label>
        <label class="txtFieldLabel">Stock type</label>

        <asp:DropDownList CssClass="form-control" ID="ddlStock_Asset_Type" runat="server"></asp:DropDownList>
        <asp:Literal ID="litVehicle_Asset_Type" runat="server"></asp:Literal>
        <asp:RequiredFieldValidator ControlToValidate="ddlStock_Asset_Type" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator27" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
...
<div class="form-row align-items-center">
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Stock description</label>

        <asp:TextBox CssClass="form-control mb-2" ID="txtStock_Description" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ControlToValidate="txtStock_Description" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator32" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Stock value</label>

        <asp:TextBox CssClass="form-control mb-2" ID="txtStock_Value" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ControlToValidate="txtStock_Value" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator33" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
</div>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddPlantEquipmentAsset.ascx.cs" Inherits="IAPR_Web.UserControls.AssetTypes.AddPlantEquipmentAsset" %>

<h6 class="m-0 font-weight-bold text-primary">Plant equipment asset details</h6>
...
<div class="form-row align-items-center">
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Plant equipment type</label>

        <asp:DropDownList CssClass="form-control" ID="ddlPlantEquipment_Asset_Type" runat="server"></asp:DropDownList>
        <asp:Literal ID="litVehicle_Asset_Type" runat="server"></asp:Literal>
        <asp:RequiredFieldValidator ControlToValidate="ddlPlantEquipment_Asset_Type" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator27" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
...
<div class="form-row align-items-center">
    <div class="form-group col-md-6">
        ...
        <asp:RequiredFieldValidator ControlToValidate="txtRegistration_Number" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator32" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
    <div class="form-group col-md-6">
        ...
        <asp:RequiredFieldValidator ControlToValidate="txtSerial_Number" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator33" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
</div>

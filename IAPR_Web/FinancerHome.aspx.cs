    ...
    public partial class FinancerHome : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    PartnerName = objUser.vcPartner_Name;
                    financerLandingTableTotals = GetFinancerDashboardTable(objUser.iPartner_Id);
                    GetFinancerDashboardCharts(objUser.iPartner_Id, financerLandingTableTotals);

                }
            }
        }
        private CCom.Dashboards.FinancerLandingTableTotals GetFinancerDashboardTable(int iPartnerId)
        {
            try
            {
                CCom.Dashboards.FinancerLandingTableTotals financerLandingTableTotals = new CCom.Dashboards.FinancerLandingTableTotals();

                financerLandingTableTotals = GetTotals(iPartnerId);
        ...
        private CCom.Dashboards.FinancerLandingTableTotals GetTotals(int iPartnerId)
        {


            CCom.Dashboards.FinancerLandingTableTotals financerLandingTableTotals = new CCom.Dashboards.FinancerLandingTableTotals();
            P.Daschboard_Provider frmF = new P.Daschboard_Provider();
            ds = frmF.Get_Financer_Landing_DashboardTable(Convert.ToInt32(iPartnerId));
        ...
        private void GetFinancerDashboardCharts(int iPartnerId, CCom.Dashboards.FinancerLandingTableTotals financerLandingTableTotals)
        {
            InsuranceStatusChart(iPartnerId, financerLandingTableTotals.AllAssetCount);
            UninsuredAgeAnaylysis(iPartnerId);
            NonPaymentReInstatedByMonthChartFinanceValue(iPartnerId);
            NonPaymentReInstatedByMonthChartAssetCount(iPartnerId);
            ...
            Communications_Current_MonthChart(iPartnerId);
            UninsuredByInsurer(iPartnerId);

        }

        #region OnlineCharts
        private void InsuranceStatusChart(int iFinancer_Id, int allAssetsCount)
        {
            P.Daschboard_Provider frmF = new P.Daschboard_Provider();
            ds = frmF.Get_Financer_Landing_Dashboard_ArrearVsUnconfirmed(iFinancer_Id);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                chartConfig.Add("exportFileName", PartnerName + "_INSURANCE_STATUS_" + String.Format("{0:yyyy_MM_dd}", DateTime.Now));
        ...
        private void UninsuredAssetsCount(int unpaid, int noInsurance)
        {
            ...
            chartConfig.Add("theme", "fusion");
            ////chartConfig.Add("exportEnabled", "1");
            chartConfig.Add("exportFileName", PartnerName + "_UNINSURED ASSETS_" + String.Format("fileName_{0:yyyy_MM_dd}", DateTime.Now));
            jsonData.Append("{'chart':{");
            foreach (var config in chartConfig)
            {
                jsonData.AppendFormat("'{0}':'{1}',", config.Key, config.Value);
        ...
        private void InsuredAssets(int adequatelyInsured, int underInsured)
        {
            ...
            chartConfig.Add("theme", "fusion");
            //chartConfig.Add("exportEnabled", "1");
            chartConfig.Add("exportFileName", PartnerName + "_INSURED ASSETS_" + String.Format("fileName_{0:yyyy_MM_dd}", DateTime.Now));
            jsonData.Append("{'chart':{");
            foreach (var config in chartConfig)
            {
                jsonData.AppendFormat("'{0}':'{1}',", config.Key, config.Value);
        ...
        private void UninsuredAgeAnaylysis(int iFinancer_Id)
        {
            P.Daschboard_Provider frmF = new P.Daschboard_Provider();
            ds = frmF.Get_Financer_Landing_Dashboard_Uninsured_Statistics(iFinancer_Id);
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                chartConfig.Add("theme", "fusion");
                //chartConfig.Add("exportEnabled", "1");
                chartConfig.Add("exportFileName", PartnerName + "_UNPAID_PREMIUM_AGE_ANALYSIS_" + DateTime.Now.ToString("MMMM", CultureInfo.InvariantCulture) + "_" + String.Format("fileName_{0:yyyy_MM_dd}", DateTime.Now));
        ...
        private void NonPaymentReInstatedByMonthChartFinanceValue(int iFinancer_Id)
        {
            P.Daschboard_Provider frmF = new P.Daschboard_Provider();
            ds = frmF.Get_Financer_Landing_Dashboard_NonPayment_History(iFinancer_Id);
            int month = DateTime.Now.Month;
            string name = DateTime.Now.ToString("MMM");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                chartConfig.Add("theme", "fusion");
                //chartConfig.Add("exportEnabled", "1");
                chartConfig.Add("exportFileName", PartnerName + "PREMIUMS_UNPAID_vs_RE_INSTATED_COVER_FINANCED VALUE_" + String.Format("fileName_{0:yyyy_MM_dd}", DateTime.Now));
        ...
        private void NonPaymentReInstatedByMonthChartAssetCount(int iFinancer_Id)
        {
            P.Daschboard_Provider frmF = new P.Daschboard_Provider();
            ds = frmF.Get_Financer_Landing_Dashboard_NonPayment_History(iFinancer_Id);
            int month = DateTime.Now.Month;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                chartConfig.Add("theme", "fusion");
                //chartConfig.Add("exportEnabled", "1");
                chartConfig.Add("exportFileName", PartnerName + "PREMIUMS_UNPAID_vs_RE_INSTATED_COVER_ASSET_COUNT_" + String.Format("fileName_{0:yyyy_MM_dd}", DateTime.Now));
        ...
        private void Communications_Current_MonthChart(int iFinancer_Id)
        {
            ...
            P.Daschboard_Provider frmF = new P.Daschboard_Provider();
            ds = frmF.Get_Financer_Landing_Dashboard_Communications_History(iFinancer_Id);
            dsReIns = frmF.Get_Financer_Landing_Dashboard_NonPayment_History(iFinancer_Id);
            int month = DateTime.Now.Month;
            string name = DateTime.Now.ToString("MMM");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                chartConfig.Add("theme", "fusion");
                //chartConfig.Add("exportEnabled", "1");
                chartConfig.Add("exportFileName", PartnerName + "CUSTOMER_NOTIFICATIONS" + String.Format("fileName_{0:yyyy_MM_dd}", DateTime.Now));
        ...
        private void UninsuredByInsurer(int iFinancer_Id)
        {
            P.Daschboard_Provider frmF = new P.Daschboard_Provider();
            ds = frmF.Get_Financer_Landing_Dashboard_Uninsured_By_Insurer(iFinancer_Id);
            int month = DateTime.Now.Month;
            string name = DateTime.Now.ToString("MMM");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                chartConfig.Add("theme", "fusion");
                //chartConfig.Add("exportEnabled", "1");
                chartConfig.Add("exportFileName", PartnerName + "UNINSURED_BY_INSURANCE_COMPANY_" + String.Format("fileName_{0:yyyy_MM_dd}", DateTime.Now));
        ...
        protected void btnDownloadDashboard_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    financerLandingTableTotals = GetTotals(objUser.iPartner_Id);
                    graphDetails.Append(Export_UninsuredStatistics(objUser.iPartner_Id) + ",");
                    graphDetails.Append(Export_NonPaymentReInstatedByMonthChartFinancedValue(objUser.iPartner_Id) + ",");
                    graphDetails.Append(Export_NonPaymentReInstatedByMonthChartAssetCount(objUser.iPartner_Id) + ",");
                    graphDetails.Append(Export_ArrearVsUnconfirmedChart(objUser.iPartner_Id, financerLandingTableTotals.AllAssetCount) + ",");
                    ...
                    graphDetails.Append(Export_Communications_Current_MonthChart(objUser.iPartner_Id) + ",");
                    graphDetails.Append(Export_UninsuredByInsurer(objUser.iPartner_Id) + ",");
        ...
        private string Export_ArrearVsUnconfirmedChart(int financer_Id, int allAssetCount)
        {
            StringBuilder data = new StringBuilder();
            P.Daschboard_Provider frmF = new P.Daschboard_Provider();
            ds = frmF.Get_Financer_Landing_Dashboard_ArrearVsUnconfirmed(financer_Id);
        ...
        private string Export_UninsuredStatistics(int financer_Id)
        {
            ...
            StringBuilder data = new StringBuilder();
            P.Daschboard_Provider frmF = new P.Daschboard_Provider();
            ds = frmF.Get_Financer_Landing_Dashboard_Uninsured_Statistics(financer_Id);
        ...
        private string Export_NonPaymentReInstatedByMonthChartFinancedValue(int financer_Id)
        {
            StringBuilder jsonData = new StringBuilder();
            StringBuilder data = new StringBuilder();
            StringBuilder tableHearders = new StringBuilder();
            ...
            P.Daschboard_Provider frmF = new P.Daschboard_Provider();
            ds = frmF.Get_Financer_Landing_Dashboard_NonPayment_History(financer_Id);
        ...
        private string Export_NonPaymentReInstatedByMonthChartAssetCount(int financer_Id)
        {
            StringBuilder jsonData = new StringBuilder();
            StringBuilder data = new StringBuilder();
            StringBuilder tableHearders = new StringBuilder();
        ...
        private string Export_Communications_Current_MonthChart(int financer_Id)
        {
            DataSet dsReIns = new DataSet();
            ...
            StringBuilder data = new StringBuilder();
            P.Daschboard_Provider frmF = new P.Daschboard_Provider();
            ds = frmF.Get_Financer_Landing_Dashboard_Communications_History(financer_Id);
            dsReIns = frmF.Get_Financer_Landing_Dashboard_NonPayment_History(financer_Id);
        ...
        private string Export_UninsuredByInsurer(int financer_Id)
        {
            StringBuilder jsonData = new StringBuilder();
            StringBuilder data = new StringBuilder();
            P.Daschboard_Provider frmF = new P.Daschboard_Provider();
            ds = frmF.Get_Financer_Landing_Dashboard_Uninsured_By_Insurer(financer_Id);
...
//            //if (param[3] != "") s.Append(param[3] + "<br /><br />");
//            //if (param[4] != "") s.Append(param[4] + "<br /><br />");
//            //if (param[5] != "") s.Append(param[5] + "<br /><br />");
//            //if (param[6] != "") s.Append(param[6] + "<br /><br />");
//            //if (param[7] != "") s.Append(param[7] + "<br /><br />");
...
//        int Number_Of_Assets = Convert.ToInt32((item.FindControl("lblNumber_Of_Assets") as Label).Text);
...
//        {
//            Total_Number_Of_Assets = Convert.ToInt32(r[1].ToString());
//            Total_Finance_Value = Convert.ToDecimal(r[2].ToString());
//            Total_Insurance_Value = Convert.ToDecimal(r[3].ToString());
//        }
//        Label lblTotalNumberOfAssets = (Label)e.Item.FindControl("lblTotalNumberOfAssets");
//        Label lblTotaFinanceValue = (Label)e.Item.FindControl("lblTotaFinance_Value");
//        Label lblTotaInsuranceValue = (Label)e.Item.FindControl("lblTotaInsurance_Value");

//        Label lblUninsured_Assets = (Label)e.Item.FindControl("lblPcetg_Uninsured_Assets");
//        Label lblUninsured_Values = (Label)e.Item.FindControl("lblPcetg_Uninsured_Value");

//        lblTotalNumberOfAssets.Text = Total_Number_Of_Assets.ToString();
//        lblTotaFinanceValue.Text = "R " + Total_Finance_Value.ToString("N", new CultureInfo("en-US"));//.ToString("#,##0.##");
//        lblTotaInsuranceValue.Text = "R " + Total_Insurance_Value.ToString("N", new CultureInfo("en-US"));//.ToString("#,##0.##");
//        if (Total_Number_Of_Assets > 0)
//        {
//            lblUninsured_Assets.Text = (decimal.Divide(Number_Of_Assets, Total_Number_Of_Assets) * 100).ToString("0.##");
//        }
//        if (Total_Finance_Value > 0)
//        {
//            lblUninsured_Values.Text = (decimal.Divide(Finance_Value, Total_Finance_Value) * 100).ToString("0.##");
//        }
...
//    }
//}
//private void NonPaymentReInstatedByMonthChart(int financer_Id)
//{
//    P.Daschboard_Provider frmF = new P.Daschboard_Provider();
//    ds = frmF.Get_Financer_Landing_Dashboard_NonPayment_History(financer_Id);
...
//        chartConfig.Add("subcaption", "Last year");
//        chartConfig.Add("yaxisname", "Number of assets");
//        chartConfig.Add("numvisibleplot", "12");
//        chartConfig.Add("labeldisplay", "auto");
//        chartConfig.Add("theme", "fusion");
//        //chartConfig.Add("exportEnabled", "1");
//        chartConfig.Add("exportFileName", PartnerName + "_UnPaidPremium_vs_Re_instated_" + String.Format("fileName_{0:yyyy_MM_dd}", DateTime.Now));
//        // json data to use as chart data source
//        jsonData.Append("{'chart':{");
//        foreach (var config in chartConfig)
//        {
...
//    else
//    {
//        divchartNonPaymentReInstatedByMonth.Attributes.Add("style", "display:none;");
//    }

//}
//private void UninsuresByAssetTypeChart(DataTable dt2)
//{

//    if (dt2.Rows.Count > 0)
//    {
//        string[] XPointMember = new string[dt2.Rows.Count];
//        int[] YPointMember = new int[dt2.Rows.Count];

//        for (int count = 0; count < dt2.Rows.Count; count++)
//        {
//            XPointMember[count] = dt2.Rows[count]["Asset_Type"].ToString() + "(" + Convert.ToInt32(dt2.Rows[count]["iNumber_Of_Assets"]) + ")";
//            //storing values for Y Axis  
//            YPointMember[count] = Convert.ToInt32(dt2.Rows[count]["iNumber_Of_Assets"]);
//        }
//        chUninsuredAssetType.Series[0].Points.DataBindXY(XPointMember, YPointMember);
//        chUninsuredAssetType.Series[0].BorderWidth = 10;

//        chUninsuredAssetType.Series[0].ChartType = SysCH.SeriesChartType.Bar;
//        chUninsuredAssetType.Series[0].BorderColor = System.Drawing.ColorTranslator.FromHtml("#1d1b42");
//        chUninsuredAssetType.ChartAreas[0].AxisX.Interval = 1;

//        for (int i = 0; i < chUninsuredAssetType.Series[0].Points.Count; i++)
//        {
//            chUninsuredAssetType.Series[0].Points[i].Color = System.Drawing.ColorTranslator.FromHtml(pointColours[0]);
//        }

//        chUninsuredAssetType.ChartAreas[0].AxisY.MajorGrid.Enabled = false;
//        chUninsuredAssetType.ChartAreas[0].AxisX.MajorGrid.Enabled = false;
//        chUninsuredAssetType.Series[0].IsValueShownAsLabel = true;
//        chUninsuredAssetType.ChartAreas[0].AxisX.LabelStyle.ForeColor = System.Drawing.Color.White;
//        chUninsuredAssetType.ChartAreas[0].AxisY.LabelStyle.ForeColor = System.Drawing.Color.White;
//        chUninsuredAssetType.ChartAreas[0].AxisX.LineColor = System.Drawing.Color.Gray;
//        chUninsuredAssetType.ChartAreas[0].AxisY.LineColor = System.Drawing.Color.Gray;
//        chUninsuredAssetType.Series[0]["PixelPointWidth"] = "25";
//        chUninsuredAssetType.ChartAreas["ChartArea1"].Area3DStyle.Enable3D = false;
//    }
//}

//private void GetFinancerDashboard_NonPaymentPreviousYear()
//{
//    P.User_Provider uP = new P.User_Provider();
//    CCom.CurrentUser objUser = new CCom.CurrentUser();
...
//    ds = frmF.Get_Financer_Landing_Dashboard_NonPayment_Annual_Chart(Convert.ToInt32(objUser.iPartner_Id));
//    DataTable dt;
...
//            //setting Chart type   
//            chNonpaymentPreviousYearAsset.Series[0].ChartType = SysCH.SeriesChartType.Column;
...
//        else
//        {
//            divchNonpaymentPreviousYearAsset.Attributes.Add("style", "display:none");
//        }
...
//            ////setting Chart type   
//            //chNonpaymentPreviousYearFinanceValue.Series[0].ChartType = SysCH.SeriesChartType.Column;
...
//        else
//        {
//            //divchNonpaymentPreviousYearFinanceValue.Attributes.Add("style", "display:none");
//        }

//    }
//}
//private void UninsuredFinanceValue(int unpaid, int noInsurance)
//{
//    StringBuilder jsonData = new StringBuilder();
//    StringBuilder data = new StringBuilder();
//    Dictionary<string, string> chartConfig = new Dictionary<string, string>();
...
//    chartConfig.Add("showpercentvalues", "1");
//    chartConfig.Add("defaultcenterlabel", "Total Assets: <b>" + (unpaid + noInsurance).ToString() + "</b>");
//    chartConfig.Add("centerlabel", "<b>$label: $value</b>");
//    chartConfig.Add("plottooltext", "<b>$label</b>: <b>$percentValue</b> ");
//    chartConfig.Add("smartLineThickness", "0.8");
//    chartConfig.Add("doughnutRadius", "90");

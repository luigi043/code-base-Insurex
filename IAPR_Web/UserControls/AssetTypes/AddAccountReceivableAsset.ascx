<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddAccountReceivableAsset.ascx.cs" Inherits="IAPR_Web.UserControls.AssetTypes.AddAccountReceivableAsset" %>




<h6 class="m-0 font-weight-bold text-primary">Account receivable details</h6>
...
<div class="form-row align-items-center">
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Account receivable type</label>

        <asp:DropDownList CssClass="form-control" ID="ddlAccountReceivable_Asset_Type" runat="server"></asp:DropDownList>
        <asp:Literal ID="litVehicle_Asset_Type" runat="server"></asp:Literal>
        <asp:RequiredFieldValidator ControlToValidate="ddlAccountReceivable_Asset_Type" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator27" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Account receivable description</label>

        <asp:TextBox CssClass="form-control mb-2" ID="txtvcAccountReceivable_Description" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ControlToValidate="txtvcAccountReceivable_Description" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator32" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>

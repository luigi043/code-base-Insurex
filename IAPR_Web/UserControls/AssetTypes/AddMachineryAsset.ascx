<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddMachineryAsset.ascx.cs" Inherits="IAPR_Web.UserControls.AssetTypes.AddMachineryAsset" %>


<h6 class="m-0 font-weight-bold text-primary">Machinery asset details</h6>
...
<div class="form-row align-items-center">
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Machinery type</label>

        <asp:DropDownList CssClass="form-control" ID="ddlMachinery_Asset_Type" runat="server"></asp:DropDownList>
        <asp:Literal ID="litVehicle_Asset_Type" runat="server"></asp:Literal>
        <asp:RequiredFieldValidator ControlToValidate="ddlMachinery_Asset_Type" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator27" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
    ...
    <div class="form-group col-md-6">
        ...
        <asp:RequiredFieldValidator ControlToValidate="txtSerial_Number" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator32" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
</div>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddBusinessInterruptionAsset.ascx.cs" Inherits="IAPR_Web.UserControls.AssetTypes.AddBusinessInterruptionAsset" %>


<h6 class="m-0 font-weight-bold text-primary">Business interruption details</h6>
...
<div class="form-row align-items-center">
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Business Interruption type</label>

        <asp:DropDownList CssClass="form-control" ID="ddlBusinessInterruption_Asset_Type" runat="server"></asp:DropDownList>
        <asp:Literal ID="litVehicle_Asset_Type" runat="server"></asp:Literal>
        <asp:RequiredFieldValidator ControlToValidate="ddlBusinessInterruption_Asset_Type" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator27" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Description</label>

        <asp:TextBox CssClass="form-control mb-2" ID="txtDescription" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ControlToValidate="txtDescription" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator32" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>

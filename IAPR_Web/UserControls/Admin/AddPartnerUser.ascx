<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddPartnerUser.ascx.cs" Inherits="IAPR_Web.UserControls.Admin.AddPartnerUser" %>

<div class="container-fluid">
    <div>

        <h6 class="m-0 font-weight-bold text-primary">Add partner user</h6>
        ...
        <div class="form-row align-items-center">
            <div class="form-group col-md-6">
                ...
                <asp:RequiredFieldValidator ControlToValidate="ddlPartnerType" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgAddPartnerUser" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator5" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>

            </div>
            <div class="form-group col-md-6">
                <label class="txtFieldLabel">Select partner</label>
                <asp:DropDownList CssClass="form-control" ID="ddlPartnerList" runat="server" AutoPostBack="true"></asp:DropDownList>
                <asp:RequiredFieldValidator ControlToValidate="ddlPartnerList" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgAddPartnerUser" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator1" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>

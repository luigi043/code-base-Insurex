<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddWatercraft.ascx.cs" Inherits="IAPR_Web.UserControls.AssetTypes.AddWatercraft" %>


<h6 class="m-0 font-weight-bold text-primary">Watercraft asset details</h6>
...
<div class="form-row align-items-center">
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Watercraft class</label>

        <asp:DropDownList CssClass="form-control" ID="ddlWatercraft_Class_Type" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlWatercraft_Class_Type_SelectedIndexChanged"></asp:DropDownList>
        <asp:Literal ID="litWatercraftClass" runat="server"></asp:Literal>
        <asp:RequiredFieldValidator ControlToValidate="ddlWatercraft_Class_Type" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator4" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Watercraft type</label>

        <asp:DropDownList CssClass="form-control" ID="ddlWatercraft_Asset_Type" runat="server"></asp:DropDownList>

        <asp:RequiredFieldValidator ControlToValidate="ddlWatercraft_Asset_Type" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator27" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
...
<div class="form-row align-items-center">
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Name/Emblem</label>

        <asp:TextBox CssClass="form-control mb-2" ID="txtName_Emblem" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ControlToValidate="txtName_Emblem" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator32" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Hull Identification Number</label>
        <asp:TextBox CssClass="form-control mb-2" ID="txtHull_Identification_Number" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ControlToValidate="txtHull_Identification_Number" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator33" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
</div>

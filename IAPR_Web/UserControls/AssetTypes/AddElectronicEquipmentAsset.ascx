<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddElectronicEquipmentAsset.ascx.cs" Inherits="IAPR_Web.UserControls.AssetTypes.AddElectronicEquipmentAsset" %>


<h6 class="m-0 font-weight-bold text-primary">Electronic asset details</h6>
...
<div class="form-row align-items-center">
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Equipment type</label>

        <asp:DropDownList CssClass="form-control" ID="ddlElectronicEquipment_Asset_Type" runat="server" OnSelectedIndexChanged="ddlElectronicEquipment_Asset_Type_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
        <asp:Literal ID="litElectronicEquipment_Asset_Type" runat="server"></asp:Literal>
        <asp:RequiredFieldValidator ControlToValidate="ddlElectronicEquipment_Asset_Type" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator27" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Serial number</label>
        <asp:TextBox CssClass="form-control mb-2" ID="txtSerial_Number" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ControlToValidate="txtSerial_Number" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator24" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
...
<div class="form-row align-items-center">
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Equipment make</label>

        <asp:DropDownList CssClass="form-control" ID="ddlElectronicEquipment_Make" runat="server" OnSelectedIndexChanged="ddlElectronicEquipment_Make_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
        <asp:RequiredFieldValidator ControlToValidate="ddlElectronicEquipment_Make" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator29" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
    <div class="form-group col-md-6">
        <label class="txtFieldLabel">Equipment model</label>
        <asp:DropDownList CssClass="form-control" ID="ddlElectronicEquipment_Model" runat="server"></asp:DropDownList>
        <asp:RequiredFieldValidator ControlToValidate="ddlElectronicEquipment_Model" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgPolicy" CssClass="txtnamevalidation erroMessage" ID="RequiredFieldValidator28" ErrorMessage="This field is required" runat="server"></asp:RequiredFieldValidator>
    </div>
